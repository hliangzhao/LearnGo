...
type Point struct {
	...
	Latitude  int32 `protobuf:"varint,1,opt,name=latitude,proto3" json:"latitude,omitempty"` // 把一个数字作为key（json以字符串为key）
...
var file_route_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x6c, 0x69, 0x61, 0x6e, 0x67, 0x7a, 0x68, 0x61, 0x6f, 0x2f,
	0x4c, 0x65, 0x61, 0x72, 0x6e, 0x47, 0x6f, 0x2f, 0x31, 0x30, 0x2d, 0x67, 0x52, 0x50, 0x43, 0x2f,
